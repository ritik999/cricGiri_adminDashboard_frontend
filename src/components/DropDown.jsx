...
const DropDown = ({ title, children }) => {
    ...
    const handleIsOpen = (title) => {
        if (isOpen == title.toLowerCase()) {
            setIsOpen('');
        } else {
            setIsOpen(title.toLowerCase());
        }
    }
    ...
    return (
        <div className="relative w-full">
            <div onClick={() => handleIsOpen(title)} className='flex justify-between items-center'>
                    ...
                    {children?.map((subTitle, index) => {
                        ...
                        return (
                            <>
                                <div
                                    key={index}
                                    onClick={() => handleNavigation(index, route, subTitle.apiEndpoint, subTitle.apiBody)}
